package mangolost.email.common.utils;

import mangolost.email.common.helper.ApiStatusCode;
import mangolost.email.exception.ServiceException;
	...
	public static Object doJsonP(Object obj, String callback) {
		...
		if (StringUtils.isBlank(callback)) {
			...
			try {
				...
				throw new ServiceException(ApiStatusCode.INTERNAL_SERVER_ERROR, "JSON处理出错");
			}
